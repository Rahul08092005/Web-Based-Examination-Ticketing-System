...
public class EligibilityCommands {
    ...
    public void eligibilityMenu() {
        ...
        while (true) {
            ...
            System.out.println("6. Export Attendance Defaulters (PDF)");
            System.out.println("7. Export Ineligible Students (PDF)");
            ...
            switch (ch) {
                ...
                case 6 -> exportAttendanceDefaultersPDF();
                case 7 -> exportIneligibleStudentsPDF();
                case 8 -> { return; }
    ...
    private void exportAttendanceDefaultersPDF() {

    System.out.print("Enter Subject Code: ");
    String code = sc.nextLine().trim();

    System.out.print("Enter output PDF file name: ");
    String path = sc.nextLine().trim();

    eligibilityService.generateAttendanceDefaultersPDF(code, path);
}

private void exportIneligibleStudentsPDF() {
    ...
    eligibilityService.generateIneligibleStudentsPDF(code, path);
}
