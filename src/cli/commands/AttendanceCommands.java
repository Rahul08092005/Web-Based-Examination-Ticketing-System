...
public class AttendanceCommands {
    ...
    public void attendanceMenu() {
        ...
        while (true) {
            ...
            System.out.println("4. Export Attendance Defaulters by Subject Code");
            ...
            else if (ch == 4) exportAttendanceNotSatisfiedBySubject();
...
private void exportAttendanceNotSatisfiedBySubject() {
    ...
    eligibilityService.exportAttendanceNotSatisfiedBySubject(code, path);
}
