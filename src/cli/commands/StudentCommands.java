...
public class StudentCommands {
    ...
    public void studentMenu() {
        while (true) {
            ...
            System.out.println("7. Export Students by Branch & Semester");
            ...
            switch (choice) {
                ...
                case 7: exportStudentsByDeptAndSemester(); break;
    ...
    // =====================================================
// EXPORT STUDENTS BY DEPARTMENT & SEMESTER (CLI FLOW)
// =====================================================
private void exportStudentsByDeptAndSemester() {

    System.out.print("Enter Department (CSE/ECE/ISE/etc): ");
    ...
    studentService.exportStudentsByDeptAndSemester(dept, sem, path);
}
