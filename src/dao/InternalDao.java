...
public class InternalDao {
    ...
    String sql = """
        ...
        FROM internal_assessments ia
        JOIN subjects sub ON ia.subject_id = sub.id
        WHERE ia.student_id = ? AND ia.subject_id = ?
    """;
...
// =====================================================
// EXPORT INTERNAL MARKS BY SUBJECT CODE
// =====================================================
public ResultSet getInternalMarksBySubject(String subjectCode)
        throws Exception {
...
// =====================================================
// EXPORT INELIGIBLE STUDENTS BY SUBJECT CODE
// =====================================================
public ResultSet getIneligibleStudentsBySubject(String subjectCode)
        throws Exception {
...
// =====================================================
// ATTENDANCE DEFAULTERS BY SUBJECT (USING ELIGIBILITY)
// =====================================================
public ResultSet getAttendanceDefaultersBySubject(String subjectCode)
        throws Exception {
...
// =====================================================
// FETCH ELIGIBILITY REASON (FOR ADMIT CARD NOTE)
// =====================================================
public String getEligibilityReason(int studentId, int subjectId) {
    ...
    try (Connection conn = DBConnectionManager.getConnection();
        ...
        ResultSet rs = ps.executeQuery();
        if (rs.next()) {
            return rs.getString("eligibility_reason");
        }

    } catch (Exception e) {
        System.out.println("Eligibility reason fetch error: " + e.getMessage());
    }
