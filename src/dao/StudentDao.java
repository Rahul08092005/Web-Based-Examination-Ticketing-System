...
public class StudentDao {
    ...
    public void insertStudent(Student s) {
        String sql = """
            ...
            (full_name, branch, usn, temp_roll_no, semester, department)
            VALUES (?, ?, ?, ?, ?, ?)
        """;
        ...
        try (Connection conn = DBConnectionManager.getConnection();
            ...
            stmt.setString(2, s.getBranch());   // ✅ branch
            stmt.setString(3, s.getUsn());
            stmt.setString(4, s.getTempRoll());
    ...
    public void updateStudent(Student s) {
        String sql = """
            UPDATE students
            SET full_name=?, branch=?, usn=?, temp_roll_no=?,
                semester=?, department=?
            WHERE id=?
        """;
    ...
    public List<Student> getStudentsByDeptAndSemester(String department, int semester) {
        ...
        try (Connection conn = DBConnectionManager.getConnection();
            ...
            System.out.println("Student export fetch error: " + e.getMessage());
        }
