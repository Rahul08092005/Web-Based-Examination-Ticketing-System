...
public class AdmitCardService {
    ...
    public void generateAdmitCard(String usn) {
        ...
        try {
            ...
            Font redBodyFont = FontFactory.getFont(
...
StringBuilder ineligibleNotes = new StringBuilder();
boolean hasIneligibleSubjects = false;
            ...
            for (Subject subject : subjects) {
                ...
                boolean eligible =
                        ...
                        if (!eligible) {
    hasIneligibleSubjects = true;

    String reason =
            internalDao.getEligibilityReason(
                    student.getId(), subject.getId()
            );

    ineligibleNotes.append(
        subject.getCode()
        + " - "
        ...
        + "\n"
                ...
                Font rowFont = eligible ? bodyFont : redBodyFont;

table.addCell(bodyCell(subject.getCode(), rowFont));
table.addCell(bodyCell(subject.getName(), rowFont));
...
table.addCell(bodyCell("", bodyFont));
            ...
            // =====================================================
// INELIGIBILITY NOTE (IF ANY)
// =====================================================
if (hasIneligibleSubjects) {
    ...
    Paragraph noteText = new Paragraph(
        "The student is NOT eligible to appear for the following subject(s):\n\n"
        + ineligibleNotes.toString(),
        FontFactory.getFont(FontFactory.HELVETICA, 9)
    );
